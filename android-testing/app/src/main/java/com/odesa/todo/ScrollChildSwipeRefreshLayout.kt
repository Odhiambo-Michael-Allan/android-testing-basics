 ...
 *
 * [ SwipeRefreshLayout ] works as expected when a scroll view is a direct child: it triggers the
 * refresh only when the view is on top. This class adds a way ( @link #setScrollUpChild ) to
